...
title: US Pre-close
regime: risk-off
summary: US Pre-close shows risk-off conditions. S&P -1.52%, NDQ -1.73%, 5% of tracked names positive, led by LMT, NFLX, MSFT.
...
- Snapshot source: yfinance auto-fetch generated 2026-03-12T20:45:12+00:00.
...
- **BA (-4.36%):** Boeing stock falls after co reportedly finds new manufacturing issue - know what it is
- **DUOL (-3.94%):** Options Corner: Why The Smart Money Is Suddenly Interested In Duolingo Stock
- **RDDT (-3.55%):** When stock markets get shaken, it can pay for investors to be patient
